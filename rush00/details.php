                        ...
                        if ($_SESSION['$prod_id'])
                        {
                            ...
                            while ($row_prod=mysqli_fetch_array($run_prod))
                            {
                                ...
                                <div id='single_product'>
                                    <h3>$prod_title</h3>
                                    <img src='./mods/product_images/$prod_image' id='whyben'/>
                                    <p><b>R$prod_price</b></p>
                                    <p>$prod_desc</p>
                                    <a href='index.php' style='float: left;'>Return</a>
                                    <a href='details.php?add_cart=$prod_id'><button style='float: right'>Add to Cart</button></a>
                                </div>
                                ";
                            }
                        }
