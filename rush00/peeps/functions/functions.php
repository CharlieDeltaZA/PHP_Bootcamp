<?php
    $con = mysqli_connect("localhost", "root", "password", "mcdb");
    ...
    function cart() {
        if (isset($_GET['add_cart']))
        {
            ...
            {
                $insert_prod = "insert into cart (prod_id,ip_add,qty) values ('$prod_id','$ip',0)";
    ...
    function getbrandprod() {
        ...
        if (isset($_GET['brand']))
        {
            ...
            if ($count_brand == 0)
                echo "<h2 style='padding: 20px;'>We have no products of this brand!</h2>";
